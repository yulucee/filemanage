...
namespace FileManageDAL.BusinessLayer.Abstract
{
    public interface IHomeDal
    {
        ...
        ServiceResult ParolamıUnuttum(string username);
        ServiceResult ResetPassword(string mail,string tempcode,string code, string sifre1, string sifre2);
        ServiceResult KullanıcıEkle(long tckimlik, string adi, string soyadi, string dogumyili, string mailadresi, string sifre1, string sifre2);
